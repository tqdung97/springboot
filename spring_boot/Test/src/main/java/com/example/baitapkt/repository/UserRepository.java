...
public class UserRepository {
    ...
    public static List<User> listFake = new ArrayList<>(List.of
            (new User(1, "dung", "dung@gmail.com", "0964182533", "ha noi", "aaa", "123"),
                    new User(2, "manh", "manh@gmail.com", "0364149113", "hcm", "bbbb", "123"),
                    new User(3, "hoang anh", "hoanganh@gmail.com", "0356418215", "thanh cccc", "linh", "123"),
                    new User(4, "thuy", "thuy@gmail.com", "0354021454", "quang nam", "ddd", "123"),
                    new User(5, "thanh", "thanh@gmail.com", "00323555521", "hue", "eee", "123"),
                    new User(6, "Manh2", "manh2@gmail.com", "036421548", "dong nai", "fff", "123")));
        ...
        for (int i = 0; i < listFake.size(); i++) {
            if (listFake.get(i).getId() == (id1)) {
                ...
                if (listFake.get(i).getPassword().equals(user.getNewPassword())) {
                    throw new ErrorMessagePass(HttpStatus.BAD_REQUEST, "Mật khẩu cũ không giống mật khẩu mới");
                } else if (!listFake.get(i).getPassword().equals(user.getOldPassword())) {
                    throw new ErrorMessagePass(HttpStatus.BAD_REQUEST, "Mật khẩu ko đúng");
                }
                break;
            }
        }
    ...
    public Page<UserDto> findPaginated(Pageable pageable) {
        ...
        return new PageImpl<>(list, PageRequest.of(currentPage, pageSize), listFake.size());
    }
