package com.example.sbsecur.person;
...
public interface PersonRepositoryInterface {
    ...
    */
    ...
    List<Map.Entry<String, Long>> findTop5PopulationCitis(); //Tìm 5 thành phố có số người thuộc danh sách sinh sống đông nhất từ vị trí thứ 5 đến vị trí thứ 1
